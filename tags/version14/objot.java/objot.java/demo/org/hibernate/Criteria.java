 ...
 * </pre>
 * 
 * You may specify projection and aggregation using <tt>Projection</tt> instances
 * obtained via the factory methods on <tt>Projections</tt>.
 * 
 * <pre>
 * List cats = session.createCriteria(Cat.class)
	...
	extends CriteriaSpecification
{
	 ...
	 * Implicitly specifies the {@link #PROJECTION} result transformer. <p/> The
	 * individual components contained within the given {@link Projection projection}
	 * determines the overall "shape" of the query result.
	 * 
	 * @param projection The projection representing the overall "shape" of the query
	 *            results.
	 ...
	 * 
	 * @param order The {@link Order order} object representing an ordering to be applied
	 *            to the results.
	 * @return this (for method chaining)
	 */
	 ...
	 * @return this (for method chaining)
	 */
	public Criteria<T> setFetchMode(String associationPath, FetchMode mode)
	 ...
	 * @return this (for method chaining)
	 */
	public Criteria<T> setLockMode(LockMode lockMode);

	/**
	 * Set the lock mode of the aliased entity
	 * 
	 * @param alias The previously assigned alias representing the entity to which the
	 *            given lock mode should apply.
	 * @param lockMode The lock mode to be applied
	 * @return this (for method chaining)
	 */
	public Criteria<T> setLockMode(String alias, LockMode lockMode);
	 ...
	 * association. <p/> The joinType is expected to be one of {@link #INNER_JOIN} (the
	 * default), {@link #FULL_JOIN}, or {@link #LEFT_JOIN}.
	 * 
	 * @param associationPath A dot-seperated property path
	 * @param alias The alias to assign to the joined association (for later reference).
	 ...
	 * @return this (for method chaining)
	 */
	public Criteria<T> createAlias(String associationPath, String alias, int joinType)
		throws HibernateException;

	/**
	 * Create a new <tt>Criteria</tt>, "rooted" at the associated entity. <p/>
	 ...
	 * given alias. <p/> Functionally equivalent to
	 * {@link #createCriteria(String, String, int)} using {@link #INNER_JOIN} for the
	 * joinType.
	 * 
	 * @param associationPath A dot-seperated property path
	 * @param alias The alias to assign to the joined association (for later reference).
	 ...
	 * @see #PROJECTION
	 */
	public Criteria<T> setResultTransformer(ResultTransformer resultTransformer);
	 ...
	 * 
	 * @param cacheable Should the result be considered cacheable; default is to not cache
	 *            (false).
	 * @return this (for method chaining)
	 */
	 ...
	 * 
	 * @param cacheRegion the name of a query cache region, or <tt>null</tt> for the
	 *            default query cache
	 * @return this (for method chaining)
	 * @see #setCacheable
	 */
	 ...
	 * @return this (for method chaining)
	 */
	public Criteria<T> setComment(String comment);
	 ...
	 * @return this (for method chaining)
	 */
	public Criteria<T> setFlushMode(FlushMode flushMode);
	 ...
	 * @return this (for method chaining)
	 */
	public Criteria<T> setCacheMode(CacheMode cacheMode);
	 ...
	 * scroll mode.
	 * 
	 * @param scrollMode Indicates the type of underlying database cursor to request.
	 * @return The {@link ScrollableResults} representing the matched query results.
	 */
